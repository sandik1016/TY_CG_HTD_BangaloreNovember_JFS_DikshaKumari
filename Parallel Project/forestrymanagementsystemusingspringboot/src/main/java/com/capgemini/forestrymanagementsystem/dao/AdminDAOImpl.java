...
public class AdminDAOImpl implements AdminDAO {
	...
	public boolean removeClient(String clientEmail) {
		...
		EntityTransaction transaction = manager.getTransaction();
		transaction.begin();
		UserBean clientBean = manager.find(UserBean.class, clientEmail);
		if (clientBean != null) {
	...
	public boolean removeScheduler(String schedulerEmail) {
		...
		EntityTransaction transaction = manager.getTransaction();
		transaction.begin();
		UserBean schedulerBean = manager.find(UserBean.class, schedulerEmail);
	...
	public boolean changePassword(String email, String password) {
			...
			EntityTransaction transaction =manager.getTransaction();
			transaction.begin();
			UserBean bean = manager.find(UserBean.class,email);
